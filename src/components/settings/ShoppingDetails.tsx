...
export default function ShoppingDetails() {
    ...
    async function handleShipmentInformationForm(e: React.FormEvent) {
        ...
        await handleShipmentInformation({ loggedinUserId, streetAddress, city, state, zipCode })
            .then(() => {
    ...
    async function handleCreditCardInformationForm(e: React.FormEvent) {
        ...
        await handleCreditCardInformation({ loggedinUserId, cardNumber, expiryMonth, expiryYear, cvc })
            .then(() => {
